  ...
  return (
    <AppShell activePath="/login">
      <section className="mx-auto grid max-w-4xl gap-6 lg:grid-cols-[1fr_1.05fr]">
        <div className="rounded-2xl border border-orange-300 bg-gradient-to-br from-orange-500 via-orange-500 to-orange-600 p-7 text-white shadow-[0_18px_40px_rgba(249,115,22,0.35)]">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-7 shadow-[0_1px_3px_rgba(15,23,42,0.06),0_16px_35px_rgba(15,23,42,0.06)]">
          ...
          <form className="mt-6 space-y-4" action="#" method="post">
            <label className="block text-sm font-medium text-slate-700">
              Email
              <span className="mt-1.5 flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2">
